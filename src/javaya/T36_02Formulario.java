...
public class T36_02Formulario extends JFrame implements ActionListener{
    private JLabel label1,label2,label3;
    private JComboBox combo1,combo2,combo3;
    private JButton boton1;
    private JTextArea textarea1;
    public T36_02Formulario() {
        setLayout(null);
        ...
        textarea1.setBounds(200,10,150,130);
        add(textarea1);
    }
    ...
    public static void main(String[] ar) {
        T36_02Formulario formulario1=new T36_02Formulario();
