/*
Confeccionar un programa que permita cargar los nombres de 5 alumnos y 
sus notas respectivas. Luego ordenar las notas de mayor a menor. 
Imprimir las notas y los nombres de los alumnos.
 */
package javaya;
import java.util.Scanner;

public class T21_PruebaVector {
    ...
    public static void main(String[] ar) {
        T21_PruebaVector pv = new T21_PruebaVector();
        pv.cargar();
        pv.ordenar();
        pv.imprimir();
    }  	
